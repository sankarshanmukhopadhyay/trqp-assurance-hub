...
**Downstream release train:** TSPP v0.12.0 · Conformance Suite v1.4.0
...
|---|---|---|---|
| Protocol verification | TRQP Conformance Suite v1.4.0 | Conformance Report and CTS evidence bundle | Combined Assurance Manifest |
| Posture computation | TRQP-TSPP v0.12.0 | Posture Report and posture evidence bundle | Combined Assurance Manifest |
| Assurance orchestration | TRQP Assurance Hub v1.7.0 | Combined Assurance Manifest and Public Assurance Summary | Relying parties, assessors, ecosystem operators |
...
The v1.7.0 contract makes this flow more explicit:
...
v1.7.0 is additive. Existing v1.6.1 Combined Assurance Manifest consumers remain compatible because the new TSMM and TIS sections are optional. Operators that claim higher assurance should prefer the new fields because they reduce ambiguity around authority, evidence, revocation, and audit scope.
