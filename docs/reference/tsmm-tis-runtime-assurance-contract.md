...
This document defines how TRQP Assurance Hub v1.7.0 projects combined assurance evidence into the portfolio architecture established by TSMM v0.21.0 and Trust Infrastructure Schemas v0.10.0.
...
| Layer | Responsibility | Hub v1.7.0 handling |
|---|---|---|
...
Hub v1.7.0 therefore keeps lifecycle state in two places:
...
A v1.7.0 assurance package should preserve:
