...
|---|---:|---:|---|---|
| v1.7.0 | v1.4.0 | v0.12.0 | supported | Runtime Assurance Contract Pack. Aligns Hub, CTS, and TSPP with TSMM v0.21.0 semantics and TIS v0.10.0 executable artifact contracts for authority, evidence, decision, registry publication, and lifecycle/status evidence. |
...
A Combined Assurance Manifest SHOULD declare the exact release tuple used to produce it. Hub v1.7.0 validates identity binding across CTS and TSPP reports, supports public assurance summaries, and can carry TSMM/TIS runtime assurance references for evidence, decision, registry publication, and status/revocation artifacts.
