...
|---|---:|---:|---|---|
| v1.6.0 | v1.3.0 | v0.11.0 | supported | Operational Trust Stack: Public Assurance and Adoption Readiness. Adds public assurance summaries, scenario profiles, interop evidence matrices, relying-party controls, and adoption packs. |
...
| v1.3.0 | v1.1.0 | v0.9.0 | maintenance | Release Set A: deterministic replay, fixture-pinned runs, posture metrics, dry-run. |
...
A Combined Assurance Manifest SHOULD declare the exact release tuple used to produce it. Hub v1.6.0 validates identity binding across CTS and TSPP reports and adds a public assurance summary layer for relying-party review.
